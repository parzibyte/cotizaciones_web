    ...
    <div class="col-sm-12 col-lg-4 offset-lg-4">
        <form ref="form" method="post" action="<?php echo BASE_URL ?>/?p=guardar_usuario">
            ...
            <div class="form-group">
                ...
                <input v-model="usuario.pass" name="pass" autocomplete="off" required type="password" class="form-control"
                       id="pass" placeholder="Escribe tu contraseña">
            </div>
            <div class="form-group">
                <label for="pass2">Confirma tu contraseña</label>
                <input v-model="usuario.pass2" name="pass2" autocomplete="off" required type="password" class="form-control"
